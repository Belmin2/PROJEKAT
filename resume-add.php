...
if (empty($name) || empty($headline) || empty($short_description) || empty($location) || empty($page_url)|| empty($salary)|| empty($age) || empty($contact)|| empty($email)||empty($tag_name)) {

echo "<h3 style='text-align:center;color:#0000;font-family:Tahoma;'>You did not fill out the requierd fields<h3>";

}

else {

$sql = "INSERT INTO resume (name,headline,short_description,location,page_url,salary,age,contact,email,tag_name) VALUES ('$_POST[name]','$_POST[headline]','$_POST[short_description]','$_POST[location]','$_POST[page_url]','$_POST[salary]','$_POST[age]','$_POST[contact]','$_POST[email]','$_POST[tag_name]')";
$result = mysqli_query($conn,$sql);
if ($result) {
  echo "Succes entered ";
} else {
                ...
                <div class="item-block">
                  <div class="item-form">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-4">
                        <div class="form-group">
                          <input type="file" name="logo" class="dropify" data-default-file="./pictures/logo-default.png">
