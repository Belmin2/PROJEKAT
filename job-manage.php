...
<html lang="en">
  ...
  <body class="nav-on-header smart-nav bg-alt">
    ...
    <!-- Page header -->
    <header class="page-header bg-img size-lg" style="background-image: url(./pictures/bg-banner1.jpg)">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.html"><img src="./pictures/logo-google.jpg" alt=""></a>
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.php"><img src="./pictures/logo-google.jpg" alt=""></a>
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.php"><img src="./pictures/logo-envato.png" alt=""></a>
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.php"><img src="./pictures/logo-facebook.png" alt=""></a>
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.php"><img src="./pictures/logo-microsoft.jpg" alt=""></a>
                  <div class="hgroup">
